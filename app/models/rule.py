...
from sqlalchemy import ForeignKey, String, DateTime, Float, Boolean, Integer, Index
...
class Rule(Base):
    ...
    suppress_for_seconds: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    escalate_after_seconds: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
